...
public abstract class AbstractLogicAssessment<DOC extends Document>
   ...
   * {@link AssessmentResultBuilder#assignTestStatus(gov.nist.secauto.decima.core.assessment.Assessment, Document, String, TestState)}
   * method must be called on the builder instance to identify the tested state of all covered derived
   * requirements. If this is not done, the requirement will default to the result state of
