...
public class SchematronAssessment extends AbstractAssessment<XMLDocument> {
    ...
    /**
     * Constructs a new {@link Assessment} that uses a Schematron ruleset to validate an XML
     * document.
     * 
     ...
     *            a handler that is capable of processing Schematron and SVRL documents based on
     *            custom logic
     */
        ...
        if (resultDir != null) {
            ...
            try (OutputStream os = new BufferedOutputStream(new FileOutputStream(schematronXslFile))) {
                ...
                throw new AssessmentException(
                        "Unable to output the compiled schematron to: " + schematronXslFile.getPath(), e);
            }
        }
