...
public class CompositeJDOMDocumentTest {
  private static final Namespace COMPOSITE_NS
      = Namespace.getNamespace("http://decima.nist.gov/xml/test");
  ...
  protected CompositeXMLDocument buildComposite()
  ...
  public void testXPathRoot()
      throws DocumentException, MalformedURLException, XPathExpressionException, XPathFactoryConfigurationException {
...
//    JDOMBasedXPathEvaluator eval = new JDOMBasedXPathEvaluator(base.getJDOMDocument(false));
    ...
    ContextAssert.assertContext(
        "/*[local-name()='test' and namespace-uri()='http://decima.nist.gov/xml/test'][1]", 2, 96,
        "classpath:templates/composite.xml", context);
  }

  @Test
  public void testXPathTemplateA()
      throws DocumentException, MalformedURLException, XPathExpressionException {
    CompositeXMLDocument base = buildComposite();
    ...
    ContextAssert.assertContext(
        ...
        2, 30, "classpath:templates/templateA.xml", base.getContext(element));
