...
public class XMLDocumentFragmentTest {
  ...
  public void testFragmentRoot()
    ...
    Element element = document.newXPathEvaluator().evaluateSingle(
        "/*[local-name()='root' and namespace-uri()='"+NS.getURI()+"'][1]",
        Filters.element());

    XMLDocumentFragment fragment = document.newXMLDocumentFragment(element);
    XPathContext context = fragment.newXPathEvaluator().getContext(
        "/*[local-name()='root']/*[local-name()='child2']");
    ContextAssert.assertContext("/*[local-name()='root' and namespace-uri()='"+NS.getURI()+"'][1]/*[local-name()='child2' and namespace-uri()='"+NS.getURI()+"'][1]", 3, 3, null, context);
  }
  ...
  public void testFragmentChild()
    ...
    Element element = document.newXPathEvaluator().evaluateSingle(
        "/*[local-name()='root' and namespace-uri()='"+NS.getURI()+"'][1]/*[local-name()='child2' and namespace-uri()='"+NS.getURI()+"'][1]",
        Filters.element());
