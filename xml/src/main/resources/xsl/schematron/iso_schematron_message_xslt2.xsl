...
<!-- Implmentation for the Schematron XML Schema Language. http://www.ascc.net/xml/resource/schematron/schematron.html 
	Copyright (c) 2000,2001 Rick Jelliffe and Academia Sinica Computing Center, 
	Taiwan This software is provided 'as-is', without any express or implied 
	...
	it and redistribute it freely, subject to the following restrictions: 1. 
...
<xsl:stylesheet version="2.0"
	...
	<!-- use default rule for process-assert and process-report: call process-message -->
