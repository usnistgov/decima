...
<!-- Stylesheet for extracting Schematron information from a RELAX-NG schema. 
	Based on the stylesheet for extracting Schematron information from W3C XML 
	Schema. Created by Eddie Robertsson 2002/06/01 Update for ISO Schematron 
	using XSLT2 Rick Jelliffe 2010/04/14 -->
