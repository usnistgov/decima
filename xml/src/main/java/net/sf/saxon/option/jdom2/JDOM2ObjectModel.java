...
public class JDOM2ObjectModel extends TreeModel implements ExternalObjectModel {
     ...
     *         return a PJConverter that takes a list of XPath nodes (represented as NodeInfo
     *         objects) and returns a collection of nodes in this object model
     */
     ...
     * representation of a value using this object model, the object model should convert the value
     * to an XPath value and return this as the result. If not, it should return null. If the object
