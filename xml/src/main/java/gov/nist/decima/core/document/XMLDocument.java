...
public interface XMLDocument extends Document, XMLContextResolver {
   ...
   * @param element the element in the current document instance to use as the base of the sub-tree
   * @return a new {@link XMLDocumentFragment} for the sub-tree
   * @throws DocumentException if an error occurred while parsing the document
   */
