...
import gov.nist.decima.core.schematron.SchematronEvaluationException;
...
public class SchematronAssessment extends AbstractAssessment<XMLDocument> {
  ...
  private static final String ASSESSMENT_TYPE = "Schematron";
   ...
   * @param phase
   *          the Schematron phase to use during the Schematron validation
