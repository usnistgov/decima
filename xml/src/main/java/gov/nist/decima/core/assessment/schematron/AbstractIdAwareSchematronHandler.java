...
public abstract class AbstractIdAwareSchematronHandler implements SchematronHandler, IdAwareSchematronHandler {
   ...
   * 
   * @param schematron the Schematron to parse to create the mapping
   */
  ...
  protected abstract AbstractDerivedRequirementParsingHandler newDerivedRequirementParsingHandler(
