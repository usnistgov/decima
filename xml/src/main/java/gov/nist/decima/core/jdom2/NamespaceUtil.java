...
public class NamespaceUtil {
   ...
   * @param uri
   *          the namespace URI
   * @param defaultPrefix the prefix to use if a new {@link Namespace} needs to be created
   * @param requirePrefix if <code>true</code> find or create a namespace that is not the default/blank namespace prefix
