...
package gov.nist.decima.core.document.context;
...
public interface XMLContextResolver {
   ...
   * @param content the {@link Content} node to build the XPath expression for
   ...
   * @param attribute the {@link Attribute} to build the XPath expression for
   * @return an XPath string
   */
