...
public class JDOMBasedXPathEvaluator
  ...
  private static final XPathFactoryImpl DEFAULT_XPATH_FACTORY
  ...
  @Override
  protected Object evaluateCompiled(XPathExpression xe, QName returnType)
      throws XPathExpressionException {
    JDOM2DocumentWrapper wrapper = new JDOM2DocumentWrapper(element.getDocument(),
