...
package gov.nist.decima.core.jdom2;

import gov.nist.decima.core.service.ResourceResolverExtensionService;
...
public class JDOMUtil {
   ...
   * 
   * @param schemaSources an array of schema to use for validation
   * @return a new {@link SAXEngine} instance
   * @throws SAXException if an error occurred while parsing the schema
   * @throws JDOMException if an error occurred while constructing the {@link SAXEngine}
