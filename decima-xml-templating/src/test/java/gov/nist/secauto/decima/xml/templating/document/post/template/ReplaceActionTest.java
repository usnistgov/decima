...
import gov.nist.secauto.decima.xml.templating.document.post.template.ReplaceAction;
...
public class ReplaceActionTest {
  ...
  public void testReplace() throws ActionException {
    ...
    Action action = new ReplaceAction(AbstractActionTest.XPATH_FACTORY, "//*[@attr='test1']", Collections.emptyMap(),
        Collections.unmodifiableList(newNodes));
